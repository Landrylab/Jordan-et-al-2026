...
# Path to the total number of reads of each sample (output of the Aviti_reads_processing_solid-selection.py script)
read_counts_path = "../results/Total_reads_processed_solid-selection_2026-04-09.csv"
...
folder_figures = "../results/intermediate_data_solid-selection/plots/"
folder_dataframes = "../results/intermediate_data_solid-selection/dataframes/"
...
for Sample in list(info.index):
    ...
    needle_file = folder_aligned + sample_name + '_solid-selection.needle'
